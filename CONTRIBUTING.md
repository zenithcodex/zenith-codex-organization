...
The following is a set of guidelines for contributing to Zenith Codex Organization and its packages, which are hosted in the [Zenith Codex Organization](https://github.com/zenith-codex) on GitHub. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
