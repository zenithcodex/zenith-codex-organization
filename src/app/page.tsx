...
import BackToTop from "@/components/zenith/BackToTop";
import ScrollProgress from "@/components/zenith/ScrollProgress";
import KeyboardShortcuts from "@/components/zenith/KeyboardShortcuts";
import SkipToContent from "@/components/zenith/SkipToContent";
...
export default function Home() {
  return (
    <>
      ...
      <main
        id="main-content"
        className="min-h-screen bg-zenith-base text-zenith-text selection:bg-zenith-cyan selection:text-zenith-black"
      >
        {/* Global Effects */}
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              logo: "https://zenith-codex.com/logo.png",
              sameAs: ["https://github.com/zenithcodex", "https://twitter.com/zenithcodex"],
              contactPoint: {
                "@type": "ContactPoint",
