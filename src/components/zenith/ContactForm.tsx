  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      toast({
        ...
        variant: "default",
        className: "bg-zenith-surface border-zenith-cyan text-zenith-text",
      });
      ...
      toast({
        ...
        description: error instanceof Error ? error.message : "Connection error. Please retry.",
        variant: "destructive",
      });
    } finally {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="group relative inline-flex items-center gap-4 bg-zenith-cyan text-zenith-base px-8 py-4 font-mono font-bold uppercase tracking-wider overflow-hidden rounded-lg shadow-lg shadow-zenith-cyan/20"
        >
      ...
      <DialogContent className="sm:max-w-[425px] bg-zenith-base border-zenith-surface text-zenith-text">
        <DialogHeader>
          <DialogTitle className="font-heading text-2xl uppercase text-zenith-text">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 mt-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="font-mono text-xs uppercase text-zenith-cyan">
                    Identifier
                  </FormLabel>
                  <FormControl>
                    <Input
                      ...
                      {...field}
                      className="bg-zenith-surface border-zenith-surface focus:border-zenith-cyan font-mono"
                    />
                  </FormControl>
            ...
            <Button
              ...
              className="w-full bg-zenith-cyan text-zenith-base hover:bg-zenith-cyan/90 font-mono font-bold uppercase"
            >
              {isSubmitting ? (
                <>
